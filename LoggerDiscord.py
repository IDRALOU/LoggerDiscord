...
ctypes.windll.kernel32.SetConsoleTitleW("LoggerDiscord - Fait par IDRALOU - Messages Supprimés: 0 | Messages Modifiés: 0")
...
async def on_message_delete(message):
    if not message.author.bot:
        ...
        if message.guild.id in data["guilds"]:
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(f"LoggerDiscord - Fait par IDRALOU - Messages Supprimés: {delete} | Messages Modifiés: {edit}")
